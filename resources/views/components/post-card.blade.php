...
>
    <div class="@if ($hasImage) sm:rounded-lg sm:p-2 sm:group-hover:bg-[var(--color-card-hover)] @else -mx-4 px-4 py-4 rounded-lg group-hover:bg-[var(--color-card-hover)] @endif">
        @if ($hasImage)
        ...
        <div class="{{ $hasImage ? 'mt-2 sm:px-1' : '' }}">
