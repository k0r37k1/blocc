    ...
    @else
        <form wire:submit="subscribe" novalidate>
            ...
            <button
                ...
                class="mt-2 text-xs font-medium text-accent hover:underline underline-offset-2 disabled:opacity-50 transition-opacity focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent rounded-sm"
            >
